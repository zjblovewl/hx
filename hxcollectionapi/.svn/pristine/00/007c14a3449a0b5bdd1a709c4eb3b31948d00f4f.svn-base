...
public class StringUtil {
	...
	*/    
	...
	public static String getYesterDayStr()
	{
	    ...
	    return new SimpleDateFormat( DATE_FORMAT_STR).format(calendar.getTime());
	}
...
////	}
	...
	public static ResponseParamVo returnResponseVo(Integer respCode,String respMsg,String token,String userId,Object body)
	{
		...
		ResponseParamVo responseParamVo = new ResponseParamVo(header,body);
		try {
			log.info("返回结果为：{}",objectMapper.writeValueAsString(responseParamVo));
		} catch (Exception e) {
			e.printStackTrace();
		}
