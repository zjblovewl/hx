...
<body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td align="left" valign="top" id="addinfo"><a href="add.jsp"
				target="mainFrame" onFocus="this.blur()" class="add">个人信息修改</a></td>
		</tr>
		<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">用户姓名：</td>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">用户密码：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">用户角色：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><select
								name="role">
									<option name="role">管理员</option>
									<option name="role">普通用户</option>
							</select></td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
