...
<head>
    ...
    <script src="../js/jquery.contextify.min.js"></script> 	
...
<section class="Hui-article-box">
     ...
     <div class="Hui-tabs">
        ...
        <div class="Hui_tabs_ul_parent">
            <ul class="Hui_tabs_ul" id="Hui_tabs_ul">
                <li class="color_theme"><a>首页</a></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe id="iframe" name="iframe" scrolling="auto" frameborder="0" src="home.jsp"></iframe>
        </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true"  data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
        	<div class="modal-header modal-header-style"></div>
            <iframe class="ui-draggable-handle" name="modal-iframe" id="modal-iframe" scrolling="no" frameborder="0" src=""></iframe>
        </div>
    </div>
</div>
<!-- 角色管理 -->
...
<script type="text/javascript">
	...
	function setWindowDialog(width,height){
		...
		if(height > innHeight){
			$.extend(true,json_style,{height:'88%'});
		}else{
			$.extend(true,json_style,{height:height+'px'});
		}		
		$("#myModal .modal-content").css(json_style);
	}

	var currentModalHeight = $('.modal-content').height();
	window.onresize = function(){
		var innHeight = window.innerHeight;	
		if(currentModalHeight > innHeight){
