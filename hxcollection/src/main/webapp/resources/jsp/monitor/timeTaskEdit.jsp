...
<body>
	...
	<div id="modal-title" class="modal-title">
		<div class="pull-left" id="title_text">新增定时任务</div>
			...
			<div class="control-group">
				<div class="controls">
					<span class="control-label">定时规则</span> <input id="expression"
						type="text" placeholder="输入定时规则" class="input-text"> 
					<div class="lable-symbol-div"></div>
				</div>
				<div class="controls">
			...
			<div class="control-group">
				<div class="controls">
					<span class="control-label">任务类</span> <input id="classname"
						type="text" placeholder="输入任务类" class="input-text"> 
					<div class="lable-symbol-div"></div>
				</div>
				<div class="controls">
					<span class="control-label">描述</span> <input id="description"
						type="text" placeholder="输入描述信息" class="input-text">
					<div class="lable-symbol-div"></div>
				</div>
			</div>
	...
	$(function(){
		...
		if(json_data.name){
			...
			$("#description").attr('title',json_data.description);
	...
	$("#submit_modal").click(function(){
			...
			if(name==""||t_group ==""||expression==""||classname==""||description==""||start_time==""||end_time==""){
				return;
			}
			 var jsonObj = {};
		...
		$("#name").change(function(){				
				...
				//校验空
				if(name == ""){
					$("#name").siblings('*:last').text("昵称不能为空");
					return;
				}
				//校验格式
				...
				$.ajax({
					...
					success:function(data){
						if(data=="false"){
							$("#name").siblings('*:last').text("任务名称已存在！");
							$("#name").val("");
							return;
						}else{
