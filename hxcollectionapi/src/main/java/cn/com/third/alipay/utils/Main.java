...
//    }
    ...
    public void test_trade_precreate() {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
            ...
            .setNotifyUrl("http://d770316e.ngrok.io/hxcollectionapi/getPaySuccessInfo")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                ZxingUtils.getQRCodeImge(response.getQrCode(), 256, "d:/zfb/aaa.png");
                break;
