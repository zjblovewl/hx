			...
			<div class="control-group">				
				<div class="controls">
					<span class="control-label">用户</span>
					 <input id=user_id type="text" user_id="" class="input-text" data-type="input-userlist" style="cursor:pointer;">
			...
			<div class="control-group">
				<div class="controls">
					<span class="control-label">起拍价格</span>
					 <input id="startPrice" type="text" data-type="input-money" class="input-text input_number_ck" >
					 <div class="lable-symbol-div"></div>
				</div>
				<div class="controls">
					<span class="control-label">每手加价</span>
					 <input id="perPrice" type="text" data-type="input-money" class="input-text input_number_ck">
					 <div class="lable-symbol-div"></div>
				</div>
			</div>
			<div class="control-group">
				<!-- <div class="controls">
					...
					<input id="currentPrice" type="text" data-type="input-money" class="input-text input_number_ck">
					<div class="lable-symbol-div"></div>
				</div> -->
				<div class="controls">
					<span class="control-label">结拍时间</span>
					 <input id="endTime" type="text" class="input-text" data-type="input-triangle" style="cursor:pointer;" readonly="readonly">
...
<script type="text/javascript">
		...
		var optionsFileAct = {
				 ...
				 success: function (data) {	
				    ...
				    if(imageIds!=null){	console.log(imageIds);
	...
	<script>
		$(function() {	
			...
			$("#submit_modal").click(function() {
				...
				params.currentPrice= $("#startPrice").val();  //当前价格，默认等于起拍价格 
				...
				if(params.nickName=="" || params.goodsName==""||params.bigClassCode==""||params.smallClassVode==""||params.startPrice==""||params.markupPrice==""
					||params.endTime==""||params.currentPrice==""||params.goodsDescription==""||params.imageIds==""||params.provinceCode==""||params.cityCode==""){
					return;
				}
				$.ajax({
					url: saveGoodsURL,
