...
<body>
	...
	<div id="modal-title" class="modal-title">
		<div class="pull-left" id="title_text">拍卖帖</div>
			...
			<div class="control-group">
				<div class="controls">
					<span class="control-label">用户</span>
					 <input id="userID" type="text" userID=""  class="input-text" style="cursor:pointer;">
			...
			<div class="control-group">
				...
				<div class="controls">
					<span class="control-label">结拍时间</span>
					 <input id="endTime"type="text" class="input-text">
