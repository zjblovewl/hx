package cn.com.pc.auction.service;
 ...
 * @版本：V1.0
 */
public interface AuctionPcService {
    ...
    /**
     * @description 加载我的其它拍卖
     * @method
     * @param  * @param null
     * @return
     * @date: 2018/4/24 15:35:45
     * @author:zhoujinbing
     */
    ResponseParamVo getOtherAuctionsByUserId(RequestParamVo vo);
}
