...
@WebAppConfiguration
public class AuctionPcControllerTest extends BaseControllerTest{

    @Autowired
    private BaseConstant baseConstant;

    String rootUrl =  super.baseUrl +  "api/auctionpc/";
    ...
    public void publishAcutionTest()
    {
        try {
            ...
            body.put("postage","20");
            body.put("end_time", DateUtil.getDateAfterDay(new Date(),5).getTime());
    ...
    public void getGoodsByTypeTest()
    {
        try {
            ...
            //goodsBody.setSearch_type(7);//(1、捡漏 2、上新 3、热门 4、我发布的 5、我参与的 6、我收藏的 7、我的足迹 )
            //goodsBody.setStart_price_distance(0);
            //goodsBody.setEnd_price_distance(80);
            long time = 1524107141000l;
            //goodsBody.setEnd_time(time);
     ...
     */
    @Test
    public void getOtherAuctionsByUserIdTest()
    {
        try {
            String url = rootUrl + "getOtherAuctionsByUserId";
            ...
            goodsBody.setPage_num(1);
            goodsBody.setPage_size(10);
            goodsBody.setUser_id("2");
            goodsBody.setGoods_id("57eed1db64154248b9f085a7112d7ed3");
    ...
    public void getGoodsDetailByIdTest()
    {
        try {
            ...
            requestParamMap.put("goods_id","aa8df4c27eaf4bebadfec25d57ea5da6");
    ...
    public void getGoodsOfferRecordTest()
    {
        try {
            ...
            // 业务参数
            Map<String, Object> body = new HashMap<String, Object>();
            body.put("goods_id","78497112131c46e69b1c1e011a594d42");//0235716ede3948ac946cbd78738532d4 1945b34cc54f4c1bb089f201cace60a7 6b0c54753b824dca9fa4e6daf8bf0079
            body.put("page_num","1");
     ...
     */
    @Test
    public void getAcutionCommentListTest()
    {
        try {
    ...
    public void getPriceByGoodsId()
    {
        try {
            ...
            InitParamHeader("hr/KjRahoSHjJ8ODdCM95p1c8OKUYxhaz/JmsG/+ZJA=","2","1","Iphone","ios10.1");//初始化头请 默认不校验Token
