...
<script>
	...
	var deleteByIdUrl =  '<%=basePath%>sellerComplaint/deleteSCById.do?rnd=' + Math.random();
	var deleteBatchUrl = '<%=basePath%>sellerComplaint/delSCBatch.do?rnd=' + Math.random();
    ...
    function complaint(row){
		...
		modalObj.modalOut("complain/complaintSaleEdit.jsp",{edit:"complain",id:row.id});		
    }
    //删除
    function deleID(id){
		modalObj.$.showConfirm("确认删除当前条目?", function(){
			$.post(deleteByIdUrl,{scIds:id});
