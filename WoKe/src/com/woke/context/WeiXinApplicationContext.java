...
{
	public static final String DOMAIN_URL = "http://4cae8b75.ngrok.io";//域名
	
	public static final String APP_ID = "wx127797bfb713d1ee";//微信公众号应用ID
	
	public static final String APP_SECRET = "8ca6001c2a7471456c4aa82268cb05b4";//微信公众号密码
