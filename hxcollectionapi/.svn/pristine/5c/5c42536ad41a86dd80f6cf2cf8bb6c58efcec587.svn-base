package cn.io.rong.methods.message;

import cn.io.rong.RongCloud;
import cn.io.rong.methods.message._private.Private;
import cn.io.rong.methods.message.chatroom.Chatroom;
import cn.io.rong.methods.message.discussion.Discussion;
import cn.io.rong.methods.message.group.Group;
import cn.io.rong.methods.message.history.History;
import cn.io.rong.methods.message.system.MsgSystem;
