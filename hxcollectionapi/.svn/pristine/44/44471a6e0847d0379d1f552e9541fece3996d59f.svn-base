package cn.com.pc.order.controller;
 ...
 */
@RestController
@RequestMapping("/api/orderpc")
public class OrderPcController extends BaseLogger{
    ...
    public @ResponseBody ResponseParamVo saveOrder(HttpServletRequest request,HttpServletResponse response){
    ...
    public @ResponseBody ResponseParamVo getSellOrderRecords(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
        ResponseParamVo result = null;
        String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo getBuyOrderRecords(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
        ResponseParamVo result = null;
        String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo getMySellOrderRecords(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
	    ResponseParamVo result = null;
        String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo getMyBuyOrderRecords(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
	    ResponseParamVo result = null;
	    String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo getOrderInfoById(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
    	ResponseParamVo result = null;
 	    String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo sendOutGoods(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
    	ResponseParamVo result = null;
 	    String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo saveOrderEvaluate(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
    	ResponseParamVo result = null;
 	    String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo cancelOrder(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
    	ResponseParamVo result = null;
 	    String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo confirmCollectGoods(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
    	ResponseParamVo result = null;
 	    String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo applyRefund(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
    	ResponseParamVo result = null;
 	    String requestJson = (String) request.getAttribute("requestJson");         
    ...
    public @ResponseBody ResponseParamVo agreeRefund(HttpServletRequest request,HttpServletResponse response){
    	response.setHeader("Access-Control-Allow-Origin","*");		
		response.setContentType("text/html; charset=UTF-8");
    	ResponseParamVo result = null;
 	    String requestJson = (String) request.getAttribute("requestJson");         
